...
{
    public class DataPipelineDelimitedSourceAdapter : DataPipelineTextSourceAdapter
    {
        ...
        public DataPipelineDelimitedSourceAdapter(TextReader textReader) : base(textReader) { }
